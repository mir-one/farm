#!/bin/bash
#
#  upgrade_post.sh - Commands to execute after a Farm upgrade
#
...
TIMER_START_update_farm_startup_script=$SECONDS
${INSTALL_CMD} update-farm-startup-script
TIMER_TOTAL_update_farm_startup_script=$((SECONDS - TIMER_START_update_farm_startup_script))
...
printf "\nupdate-farm-startup-script: %s s" "${TIMER_TOTAL_update_farm_startup_script}"
