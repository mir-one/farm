...
WIDGET_INFORMATION = {
    ...
    'dependencies_module': [
        ...
        [
            ...
            '/var/farm-root/farm/farm_flask/static/js/user_js/solid-gauge-9.1.2.js'
        ],
        [
            ...
            'cp -rf Highcharts-Stock-9.1.2/code/modules/solid-gauge.js /var/farm-root/farm/farm_flask/static/js/user_js/solid-gauge-9.1.2.js',
            'cp -rf Highcharts-Stock-9.1.2/code/modules/solid-gauge.js.map /var/farm-root/farm/farm_flask/static/js/user_js/solid-gauge.js.map',
            'rm -rf Highcharts-Stock-9.1.2.zip',
...
{%- set measurement_id = widget_options['measurement'].split(",")[1] -%}
  ...
  widget['{{each_widget.unique_id}}'] = new Highcharts.chart({
    ...
    credits: {
      enabled: false,
      href: "https://github.com/mir-one/Farm",
      text: "Farm"
    }
  });
"""
