# coding=utf-8
#
#  backup_rsync.py - Periodically perform backup of Farm assets to remote system using rsync
#
...
from farm.config import PATH_MEASUREMENTS_BACKUP
from farm.config import PATH_SETTINGS_BACKUP
...
FUNCTION_INFORMATION = {
    ...
    'custom_options': [
        ...
        },
        {
            ...
            'type': 'text',
            'default_value': '/home/pi/backup_farm_{}'.format(host_name),
            'required': True,
...
class CustomModule(AbstractFunction):
    ...
    def backup_settings(self):
        filename = 'Farm_{mver}_Settings_{aver}_{host}_{dt}.zip'.format(
    ...
    def backup_measurements(self):
        ...
        filename = 'Farm_{mv}_Influxdb_{iv}_{host}_{dt}.zip'.format(
