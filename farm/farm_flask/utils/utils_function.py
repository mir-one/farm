...
from farm.config import PID_INFO
...
from farm.farm_flask.utils.utils_general import custom_options_return_json
...
def action_add(form):
    ...
    try:
        ...
        if form.action_type.data == 'command':
            new_action.do_output_state = 'farm'  # user to execute shell command as
