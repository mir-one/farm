...
from farm.config import PATH_1WIRE
...
from farm.farm_flask.forms import forms_input
from farm.farm_flask.forms import forms_math
from farm.farm_flask.routes_static import inject_variables
from farm.farm_flask.utils import utils_general
from farm.farm_flask.utils import utils_input
from farm.farm_flask.utils import utils_math
...
from farm.utils.system_pi import check_missing_ids
from farm.utils.system_pi import csv_to_list_of_str
from farm.utils.system_pi import dpkg_package_exists
from farm.utils.system_pi import list_to_csv
from farm.utils.system_pi import parse_custom_option_values
from farm.utils.system_pi import parse_custom_option_values_input_channels_json

logger = logging.getLogger('farm.farm_flask.routes_input')
...
def page_input():
    ...
    math_path = os.path.join(
        INSTALL_DIRECTORY,
        'farm/farm_flask/templates/pages/data_options/math_options')
    ...
    input_path = os.path.join(
        INSTALL_DIRECTORY,
        'farm/farm_flask/templates/pages/data_options/input_options')
