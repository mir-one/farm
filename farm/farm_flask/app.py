# coding=utf-8
#
#  app.py - Flask web server for Farm
#
import base64
import logging
...
from farm.config import ProdConfig
from farm.databases.models import Misc
from farm.databases.models import User
from farm.databases.models import populate_db
from farm.databases.utils import session_scope
from farm.farm_flask import routes_admin
from farm.farm_flask import routes_authentication
from farm.farm_flask import routes_dashboard
from farm.farm_flask import routes_function
from farm.farm_flask import routes_general
from farm.farm_flask import routes_input
from farm.farm_flask import routes_method
from farm.farm_flask import routes_output
from farm.farm_flask import routes_page
from farm.farm_flask import routes_password_reset
from farm.farm_flask import routes_remote_admin
from farm.farm_flask import routes_settings
from farm.farm_flask import routes_static
from farm.farm_flask.api import api_blueprint
from farm.farm_flask.api import init_api
from farm.farm_flask.extensions import db
from farm.farm_flask.utils.utils_dashboard import register_widget_endpoints
from farm.farm_flask.utils.utils_general import get_ip_address
...
def extension_session(app):
    # TODO: Remove this code if Farm doesn't produce this issue anymore
    ...
    #     import shutil
    #     shutil.rmtree('/var/farm-root/farm/flask_session')
    # except:
    #     pass
