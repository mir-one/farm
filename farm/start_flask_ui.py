...
from farm.config import ENABLE_FLASK_PROFILER
from farm.farm_flask.app import create_app
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Farm Flask HTTP server.")
    ...
    if args.ssl:
        ...
        cert = os.path.join(dir_path, "farm_flask/ssl_certs/server.crt")
        privkey = os.path.join(dir_path, "farm_flask/ssl_certs/server.key")
