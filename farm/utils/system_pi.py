...
from farm.config_devices_units import UNIT_CONVERSIONS
...
logger = logging.getLogger("farm.system_pi")
...
def cmd_output(command, stdout_pipe=True, shell=True, timeout=360, user='farm', cwd='/home'):
    """
...
def can_perform_backup():
    ...
    """
    free_before = get_directory_free_space('/var/Farm-backups')
