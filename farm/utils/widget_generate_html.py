...
logger = logging.getLogger("farm.utils.widget_generate_html")
    ...
    for widget_name in dict_widgets:
        try:
            ...
            with open(path_head, 'w') as fw:
                ...
                fw.write(html_head)
                fw.close()
            set_user_grp(path_head, 'farm', 'farm')
            ...
            with open(path_title_bar, 'w') as fw:
                ...
                fw.close()
            set_user_grp(path_title_bar, 'farm', 'farm')
            ...
            with open(path_body, 'w') as fw:
                ...
                fw.write(html_body)
                fw.close()
            set_user_grp(path_body, 'farm', 'farm')
            ...
            with open(path_configure_options, 'w') as fw:
                ...
                fw.close()
            set_user_grp(path_configure_options, 'farm', 'farm')
            ...
            with open(path_js, 'w') as fw:
                ...
                fw.write(html_js)
                fw.close()
            set_user_grp(path_js, 'farm', 'farm')
            ...
            with open(path_js_ready, 'w') as fw:
                ...
                fw.close()
            set_user_grp(path_js_ready, 'farm', 'farm')
            ...
            with open(path_js_ready_end, 'w') as fw:
                ...
                fw.close()
            set_user_grp(path_js_ready_end, 'farm', 'farm')
        except Exception:
