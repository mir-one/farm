...
- Type: Select
- Description: Set the state when Farm starts

##### Shutdown State

- Type: Select
- Description: Set the state when Farm shuts down
...
- Type: Decimal
- Description: The value when Farm starts
...
- Type: Decimal
- Description: The value when Farm shuts down
...
- Type: Select
- Description: Set the state of the relay when Farm starts

##### Shutdown State

- Type: Select
- Description: Set the state of the relay when Farm shuts down
...
- Type: Select
- Description: Set the state of the GPIO when Farm starts

##### Shutdown State

- Type: Select
- Description: Set the state of the GPIO when Farm shuts down
...
- Description: Choose whether the enable pin in pulled high (Enable) or low (Disable) when Farm shuts down.
...
This output uses a 315 or 433 MHz transmitter to turn wireless power outlets on or off. Run ~/Farm/farm/devices/wireless_rpi_rf.py with a receiver to discover the codes produced from your remote.
