The Farm client is a command-line tool used to communicate with the daemon.

```console
pi@raspberry:~ $ farm-client --help
usage: farm-client [-h] [-c] [--activatecontroller CONTROLLER ID]
...
optional arguments:
  ...
  --deactivatecontroller CONTROLLER ID
                        ...
                        Math, PID, Input
  --ramuse              Return the amount of ram used by the Farm daemon
